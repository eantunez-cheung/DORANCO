 ...
 * 
 */
@WebServiceClient(name = "EtudiantService", targetNamespace = "http://jaxws.doranco.fr/", wsdlLocation = "http://localhost:9991/ws/etudiant-service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ETUDIANTSERVICE_QNAME = new QName("http://jaxws.doranco.fr/", "EtudiantService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9991/ws/etudiant-service?wsdl");
    ...
    public EtudiantService getEtudiantPort() {
        return super.getPort(new QName("http://jaxws.doranco.fr/", "EtudiantPort"), EtudiantService.class);
    }
    ...
    public EtudiantService getEtudiantPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.doranco.fr/", "EtudiantPort"), EtudiantService.class, features);
    }
